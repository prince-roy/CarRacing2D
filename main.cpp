...
void fristDesign(){
      ...
      glColor3f(0.133, 0.545, 0.133);
        ...
        glColor3f(1.000, 1.000, 0.000);
        renderBitmapString(30,80,(void *)font1,"     Car Racing(2D)    ");
        ...
        glColor3f(1.000, 1.000, 1.000);
        renderBitmapString(30,50-6+10,(void *)font3,"Press UP to Maximize Speed");
        renderBitmapString(30,50-8+10,(void *)font3,"Press DOWN to Minimize Speed");
